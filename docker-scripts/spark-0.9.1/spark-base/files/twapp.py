...
mdb = mongo['twapp_storage_new']
mdb2 = mongo['twapp_storage_cnt']
...
def mapper(line, title, secfile, idsec):
    ...
    posting = { "securitynow_id": idsec, "episode" : secfile[3:6], "speaker": title, "original" : line, "tokens" : tokens, "entities" : ntities, "sentiment" : classifier.classify(sentclas) }
...
if __name__ == "__main__":
    ...
    for post in secnow_c.find():
        print post
        counter(post['Data'], post['Titles'], post['File'], post['_id'])
