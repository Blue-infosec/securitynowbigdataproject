...
spark_shell_images=( "spark-shell:0.9.1" "spark-shell:0.9.0" )
shark_shell_images=( "shark-shell:0.8.0" )
...
if [ "$image_type" == "spark" ]; then
    ...
    if [ "$SHARK_VERSION" == "0.9.0" ] || [ "$SHARK_VERSION" == "0.8.0" ] || [ "$SHARK_VERSION" == "0.9.1" ]; then
